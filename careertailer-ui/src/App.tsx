...
function App() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // NEW: Increment the counter to tell the sidebar to refresh!
  ...
  return (
    // 1. Wrap the entire app in a flex container to place the sidebar on the right
    <div className="flex h-screen bg-gray-50 text-gray-800 font-sans overflow-hidden">
      
      {/* 2. Main Content Area (Takes up remaining space, scrolls independently) */}
      <div className="flex-1 flex flex-col h-full overflow-y-auto">
        ...
        <header className="bg-white border-b border-gray-200 py-4 px-8 flex items-center justify-between shadow-sm sticky top-0 z-10">
          ...
          <div className="text-sm text-gray-500">v0.4 (With History)</div>
        </header>
